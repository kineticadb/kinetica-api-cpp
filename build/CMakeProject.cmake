...
# Set this variable in an earlier CMakeLists.txt to set a default build type.
if (NOT DEFINED CMAKE_BUILD_TYPE_DEFAULT)
...
message(STATUS "* ---------------------------------------------------------------------------" )
message(STATUS "* CMake general command line options :" )
message(STATUS "* " )
message(STATUS "* In the cmake-gui you can set values and press configure a few times " )
message(STATUS "*   until there are no more red items, then press generate." )
message(STATUS "* On the command line set the variables using the -D option." )
message(STATUS "*   Ex: cmake -D[OPTION_NAME]=[OPTION_VALUE] /path/to/CMakeLists.txt/dir/" )
message(STATUS "* ---------------------------------------------------------------------------" )
...
message(STATUS "*   Makefiles : Set the build type, default is '${CMAKE_BUILD_TYPE_DEFAULT}'." )
...
# have to do this since CMAKE_BUILD_TYPE is "" initially.
if ("${CMAKE_BUILD_TYPE}" STREQUAL "")
    if (NOT MSVC)
        MESSAGE(STATUS "* No CMAKE_BUILD_TYPE was specified, using default '${CMAKE_BUILD_TYPE_DEFAULT}'")
    endif (NOT MSVC)
...
message(STATUS "* Build Arch        = 32-bit ${IS_32_BIT}, is 64-bit ${IS_64_BIT}")
