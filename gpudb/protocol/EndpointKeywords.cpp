...
namespace gpudb
{
    ...
    const std::string create_join_table_allow_right_primary_key_join( "allow_right_primary_key_join" );
    ...
    const std::string show_table_manual                  ( "manual"                   );
    ...
    const std::string show_table_on_change               ( "on_change"                );
    const std::string show_table_periodic                ( "periodic"                 );
