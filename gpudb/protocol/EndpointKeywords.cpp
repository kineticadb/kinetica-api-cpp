...
namespace gpudb
{
    ...
    const std::string admin_ha_offline_false( "false" );
    const std::string admin_ha_offline_true ( "true"  );
    ...
    const std::string admin_send_alert_debug( "debug" );
    const std::string admin_send_alert_error( "error" );
    const std::string admin_send_alert_fatal( "fatal" );
    const std::string admin_send_alert_info ( "info"  );
    const std::string admin_send_alert_warn ( "warn"  );
    ...
    const std::string admin_verify_db_table_excludes             ( "table_excludes"              );
    const std::string admin_verify_db_table_includes             ( "table_includes"              );
    ...
    const std::string aggregate_group_by_compression_codec              ( "compression_codec"               );
    ...
    const std::string aggregate_group_by_result_table_generate_soft_pk  ( "result_table_generate_soft_pk"   );
    ...
    const std::string aggregate_unique_compression_codec            ( "compression_codec"             );
    ...
    const std::string aggregate_unpivot_compression_codec            ( "compression_codec"             );
    ...
    const std::string alter_backup_checksum                       ( "checksum"                        );
    const std::string alter_backup_comment                        ( "comment"                         );
    const std::string alter_backup_ddl_only                       ( "ddl_only"                        );
    const std::string alter_backup_dry_run                        ( "dry_run"                         );
    const std::string alter_backup_false                          ( "false"                           );
    const std::string alter_backup_max_incremental_backups_to_keep( "max_incremental_backups_to_keep" );
    const std::string alter_backup_merge                          ( "merge"                           );
    const std::string alter_backup_purge                          ( "purge"                           );
    const std::string alter_backup_true                           ( "true"                            );
    ...
    const std::string alter_datasource_schema_registry_connection_retries( "schema_registry_connection_retries" );
    const std::string alter_datasource_schema_registry_connection_timeout( "schema_registry_connection_timeout" );
    ...
    const std::string append_records_pk_conflict_predicate_higher( "pk_conflict_predicate_higher" );
    const std::string append_records_pk_conflict_predicate_lower ( "pk_conflict_predicate_lower"  );
    ...
    const std::string clear_tables_false                 ( "false"                  );
    const std::string clear_tables_no_error_if_not_exists( "no_error_if_not_exists" );
    const std::string clear_tables_true                  ( "true"                   );
    ...
    const std::string create_backup_datasource                     ( "datasource"                      );
    ...
    const std::string create_datasource_schema_registry_connection_retries( "schema_registry_connection_retries" );
    const std::string create_datasource_schema_registry_connection_timeout( "schema_registry_connection_timeout" );
    ...
    const std::string create_job_query_id( "query_id" );
    ...
    const std::string create_join_table_enable_equi_join_lazy_result_store          ( "enable_equi_join_lazy_result_store"           );
    const std::string create_join_table_enable_pk_equi_join                         ( "enable_pk_equi_join"                          );
    const std::string create_join_table_enable_predicate_equi_join_lazy_result_store( "enable_predicate_equi_join_lazy_result_store" );
    const std::string create_join_table_enable_sparse_virtual_chunking              ( "enable_sparse_virtual_chunking"               );
    ...
    const std::string create_projection_compression_codec              ( "compression_codec"               );
    ...
    const std::string create_table_compression_codec      ( "compression_codec"       );
    ...
    const std::string create_table_external_schema_registry_connection_retries                 ( "schema_registry_connection_retries"                  );
    const std::string create_table_external_schema_registry_connection_timeout                 ( "schema_registry_connection_timeout"                  );
    const std::string create_table_external_schema_registry_max_consecutive_connection_failures( "schema_registry_max_consecutive_connection_failures" );
    ...
    const std::string create_table_external_type_inference_max_records_read                    ( "type_inference_max_records_read"                     );
    ...
    const std::string create_type_compress         ( "compress"          );
    const std::string create_type_compression_codec( "compression_codec" );
    ...
    const std::string create_union_compression_codec      ( "compression_codec"       );
    ...
    const std::string execute_sql_result_table_list( "result_table_list" );
    ...
    const std::string get_records_arrow            ( "arrow"             );
    ...
    const std::string grant_permission_send_alert       ( "send_alert"        );
    ...
    const std::string grant_permission_system_system_send_alert( "system_send_alert" );
    ...
    const std::string has_permission_send_alert            ( "send_alert"             );
    ...
    const std::string insert_records_from_files_compression_codec                                  ( "compression_codec"                                   );
    ...
    const std::string insert_records_from_files_schema_registry_connection_retries                 ( "schema_registry_connection_retries"                  );
    const std::string insert_records_from_files_schema_registry_connection_timeout                 ( "schema_registry_connection_timeout"                  );
    const std::string insert_records_from_files_schema_registry_max_consecutive_connection_failures( "schema_registry_max_consecutive_connection_failures" );
    ...
    const std::string insert_records_from_files_type_inference_max_records_read                    ( "type_inference_max_records_read"                     );
    ...
    const std::string insert_records_from_payload_compression_codec                                  ( "compression_codec"                                   );
    ...
    const std::string insert_records_from_payload_schema_registry_connection_retries                 ( "schema_registry_connection_retries"                  );
    const std::string insert_records_from_payload_schema_registry_connection_timeout                 ( "schema_registry_connection_timeout"                  );
    const std::string insert_records_from_payload_schema_registry_max_consecutive_connection_failures( "schema_registry_max_consecutive_connection_failures" );
    ...
    const std::string insert_records_from_payload_type_inference_max_records_read                    ( "type_inference_max_records_read"                     );
    ...
    const std::string revoke_permission_send_alert   ( "send_alert"    );
    ...
    const std::string revoke_permission_system_system_send_alert( "system_send_alert" );
    ...
    const std::string show_backup_object_names          ( "object_names"           );
    const std::string show_backup_show_contents         ( "show_contents"          );
    const std::string show_backup_true                  ( "true"                   );
    ...
    const std::string show_environment_show_names_only       ( "show_names_only"        );
    ...
    const std::string show_table_alter_count                         ( "alter_count"                          );
    ...
    const std::string show_table_compression_codec                   ( "compression_codec"                    );
    ...
    const std::string show_table_created_by                          ( "created_by"                           );
    const std::string show_table_created_time                        ( "created_time"                         );
    ...
    const std::string show_table_last_alter_by                       ( "last_alter_by"                        );
    const std::string show_table_last_alter_time                     ( "last_alter_time"                      );
    const std::string show_table_last_read_by                        ( "last_read_by"                         );
    const std::string show_table_last_read_time                      ( "last_read_time"                       );
    const std::string show_table_last_refresh_time                   ( "last_refresh_time"                    );
    const std::string show_table_last_write_by                       ( "last_write_by"                        );
    const std::string show_table_last_write_time                     ( "last_write_time"                      );
    ...
    const std::string show_table_read_count                          ( "read_count"                           );
    ...
    const std::string show_table_write_count                         ( "write_count"                          );
