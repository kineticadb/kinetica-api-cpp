...
namespace gpudb
{
    ...
    struct CreateUserExternalRequest
    {
         ...
         *                      <ul>
         *                          <li>@ref
         *                              gpudb::create_user_external_activated
         *                              "create_user_external_activated": Is
         ...
         * Optional parameters.
         * <ul>
         *     <li>@ref gpudb::create_user_external_activated
         *         "create_user_external_activated": Is the user allowed to
         *         login.
         *         Supported values:
         *         <ul>
