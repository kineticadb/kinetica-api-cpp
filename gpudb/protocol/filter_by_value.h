...
namespace gpudb
{
    ...
    struct FilterByValueRequest
    {
         ...
         * @param[in] value_  The value to search for. The default value is 0.
         * @param[in] valueStr_  The string value to search for. The default
         *                       value is ''.
         ...
         *                      <ul>
         *                          <li>@ref
         *                              gpudb::filter_by_value_create_temp_table
         *                              "filter_by_value_create_temp_table": If
         *                              @ref gpudb::filter_by_value_true
         ...
         *         gpudb::filter_by_value_true "true", a unique temporary table
         ...
         *                 "filter_by_value_false"
         *         </ul>
         *         The default value is @ref gpudb::filter_by_value_false
         *         "filter_by_value_false".
         *     <li>@ref gpudb::filter_by_value_collection_name
         *         "filter_by_value_collection_name": [DEPRECATED--please
...
namespace gpudb
{
    ...
    struct FilterByValueResponse
    {
         ...
         * <ul>
         *     <li>@ref gpudb::filter_by_value_qualified_view_name
         *         "filter_by_value_qualified_view_name": The fully qualified
