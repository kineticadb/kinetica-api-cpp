...
namespace gpudb
{
    ...
    struct CreateGraphRequest
    {
         ...
         * @param[in] directedGraph_  If set to @ref gpudb::create_graph_true
         *                            "true", the graph will be directed. If
         *                            set to @ref gpudb::create_graph_false
         *                            "false", the graph will not be directed.
         *                            Consult <a
         ...
         *                    NODE_WKTPOINT', or constant values, e.g., '{9,
         *                    10, 11} AS NODE_ID'. If using constant values in
         ...
         *                    constant values, e.g., "{'family', 'coworker'} AS
         *                    EDGE_LABEL". If using constant values in an
         ...
         *                      WEIGHTS_VALUESPECIFIED', or constant values,
         *                      e.g., '{4, 15} AS WEIGHTS_VALUESPECIFIED'. If
         *                      using constant values in an identifier
         ...
         *                      <ul>
         *                          <li>@ref
         *                              gpudb::create_graph_merge_tolerance
         *                              "create_graph_merge_tolerance": If node
         *                              geospatial positions are input (e.g.,
         *                              WKTPOINT, X, Y), determines the minimum
         *                              separation allowed between unique
         *                              nodes. If nodes are within the
         *                              tolerance of each other, they will be
         *                              merged as a single node. The default
         *                              value is '1.0E-5'.
         *                          <li>@ref gpudb::create_graph_recreate
         *                              "create_graph_recreate": If set to @ref
         *                              gpudb::create_graph_true "true" and the
         *                              graph (using @a graphName_) already
         *                              exists, the graph is deleted and
         *                              recreated.
         *                              Supported values:
         *                              <ul>
         ...
         *                              gpudb::create_graph_false
         *                              "create_graph_false".
         *                          <li>@ref gpudb::create_graph_save_persist
         *                              "create_graph_save_persist": If set to
         *                              @ref gpudb::create_graph_true "true",
         ...
         *                              gpudb::create_graph_false "false", the
         ...
         *                              "create_graph_false".
         *                          <li>@ref
         *                              gpudb::create_graph_add_table_monitor
         *                              "create_graph_add_table_monitor": Adds
         ...
         *                              gpudb::create_graph_save_persist
         *                              "save_persist" is also set to @ref
         *                              gpudb::create_graph_true "true", the
         ...
         *                              criteria</a>.  The table will have the
         ...
         *                              "create_graph_add_turns": Adds dummy
         ...
         *                              "create_graph_server_id": Indicates
         ...
         *                              "create_graph_use_rtree": Use an range
         ...
         *                              "create_graph_true".
         *                          <li>@ref
         *                              gpudb::create_graph_label_delimiter
         *                              "create_graph_label_delimiter": If
         ...
         *                              "create_graph_true".
         *                          <li>@ref
         *                              gpudb::create_graph_embedding_table
         *                              "create_graph_embedding_table": If
        ...
        /**
         * If set to @ref gpudb::create_graph_true "true", the graph will be
         * directed. If set to @ref gpudb::create_graph_false "false", the
        ...
        /**
         * Nodes represent fundamental topological units of a graph. Nodes must
         ...
         * e.g., 'ST_MAKEPOINT(column1, column2) AS NODE_WKTPOINT', or constant
         * values, e.g., '{9, 10, 11} AS NODE_ID'. If using constant values in
         ...
         * e.g., 'SUBSTR(column, 1, 6) AS EDGE_NODE1_NAME', or constant values,
         * e.g., "{'family', 'coworker'} AS EDGE_LABEL". If using constant
        ...
        /**
         * Weights represent a method of informing the graph solver of the cost
         * of including a given edge in a solution. Weights must be specified
         * using <a
         * href="../../../graph_solver/network_graph_solver/#identifiers"
         * target="_top">identifiers</a>; identifiers are grouped as <a
         * href="../../../graph_solver/network_graph_solver/#id-combos"
         ...
         * constant values, e.g., '{4, 15} AS WEIGHTS_VALUESPECIFIED'. If using
         ...
         * edges and/or nodes should be ignored for the solution. Restrictions
         ...
         *         "create_graph_merge_tolerance": If node geospatial positions
         *         are input (e.g., WKTPOINT, X, Y), determines the minimum
         *         separation allowed between unique nodes. If nodes are within
         *         the tolerance of each other, they will be merged as a single
         *         node. The default value is '1.0E-5'.
         *     <li>@ref gpudb::create_graph_recreate "create_graph_recreate":
         *         If set to @ref gpudb::create_graph_true "true" and the graph
         *         (using @ref graphName) already exists, the graph is deleted
         *         and recreated.
         *         Supported values:
         *         <ul>
         ...
         *         </ul>
         *         The default value is @ref gpudb::create_graph_false
         *         "create_graph_false".
         *     <li>@ref gpudb::create_graph_save_persist
         *         "create_graph_save_persist": If set to @ref
         *         gpudb::create_graph_true "true", the graph will be saved in
         *         the persist directory (see the <a
         *         href="../../../config/#config-main-persistence"
         *         target="_top">config reference</a> for more information). If
         *         set to @ref gpudb::create_graph_false "false", the graph
         ...
         *         "create_graph_add_table_monitor": Adds a table monitor to
         ...
         *         restart, if @ref gpudb::create_graph_save_persist
         *         "save_persist" is also set to @ref gpudb::create_graph_true
         ...
         *         "create_graph_false".
         *     <li>@ref gpudb::create_graph_graph_table
         *         "create_graph_graph_table": If specified, the created graph
         ...
         *     <li>@ref gpudb::create_graph_add_turns "create_graph_add_turns":
         ...
         *         The default value is @ref gpudb::create_graph_false
         *         "create_graph_false".
         *     <li>@ref gpudb::create_graph_server_id "create_graph_server_id":
         *         Indicates which graph server(s) to send the request to.
         *         Default is to send to the server with the most available
         *         memory.
         *     <li>@ref gpudb::create_graph_use_rtree "create_graph_use_rtree":
         ...
         *         "create_graph_label_delimiter": If provided the label string
         ...
         *         "create_graph_allow_multiple_edges": Multigraph choice;
         ...
         *         "create_graph_embedding_table": If table exists (should be
