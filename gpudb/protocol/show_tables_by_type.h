...
namespace gpudb
{
     ...
     * GPUdb::showTablesByType(const ShowTablesByTypeRequest&) const
    ...
    struct ShowTablesByTypeRequest
    {
         ...
         * parameters.
         *
         * @param[in] typeId_  Type id returned by a call to @ref
        ...
        /**
         * Type id returned by a call to @ref
         * GPUdb::createType(const CreateTypeRequest&) const
         * "GPUdb::createType".
         */
        std::string typeId;
...
namespace gpudb
{
    ...
    {
        /**
         * Constructs a ShowTablesByTypeResponse object with default
         * parameters.
         */
...
#endif // __SHOW_TABLES_BY_TYPE_H__
