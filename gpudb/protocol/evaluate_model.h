...
namespace gpudb
{
     ...
     * #evaluateModel(const EvaluateModelRequest&) const}.
     * <p>
     * @private
     */
    struct EvaluateModelRequest
    {
        ...
        /**
         * @private
         * Constructs an EvaluateModelRequest object with default parameter
         * values.
         */
        ...
        /**
         * @private
         * Constructs an EvaluateModelRequest object with the specified
         * parameters.
         * 
         * @param[in] modelName_
         * @param[in] replicas_
         * @param[in] deploymentMode_
         * @param[in] sourceTable_
         * @param[in] destinationTable_
         * @param[in] options_
         * 
         */
...
namespace gpudb
{
    ...
    struct EvaluateModelResponse
    {
        ...
        /**
         * @private
         * Constructs an EvaluateModelResponse object with default parameter
         * values.
         */
