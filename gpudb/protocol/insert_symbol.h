...
namespace gpudb
{
    ...
    struct InsertSymbolRequest
    {
         ...
         *                      <ul>
         *                              <li> gpudb::insert_symbol_color: If @a
         *                      symbolFormat is 'svg' this is ignored. If @a
         *                      symbolFormat is 'svg_path' then this option
         *                      specifies the color (in RRGGBB hex format) of
         *                      the path. For example, to have the path
         *                      rendered in red, used 'FF0000'. If 'color' is
         *                      not provided then '00FF00' (i.e. green) is used
         *                      by default.
         *                      </ul>
         * 
         */
